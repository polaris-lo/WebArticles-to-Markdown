...
- 🤖 **LLM 后处理**：可选接入 DeepSeek / Claude，自动重排版、去广告、生成中文摘要、提炼导读问题，并可运行批判性阅读（五问法）和领域知识地图（三问法）深度分析
...
- **Q1 逻辑边界** — 文章能得出什么结论、不能得出什么结论；作者在哪里超越了证据
- **Q2 隐藏假设** — 未明说的前提、被忽略的变量，以及它们对结论的影响
- **Q3 适用范围** — 论点在哪些场景下不成立，以及它实际要求什么条件
- **Q4 争论立场** — 文章持什么立场，最有力的反驳是什么
- **Q5 缺席视角** — 文章中缺少哪些声音，以及这种缺席如何影响结论

Q4、Q5 在内容不实质（如纯教程）时省略。

### 领域知识地图（三问法）

- **Q1 专家共识** — 该领域公认的 5 个核心心智模型
- **Q2 核心分歧** — 专家之间真实存在的 3 个争议点，以及各方最有力的论据
